...
def createTrees(ctx, tcu, dic_obj, dic_objs):
	...
	txt = "Generated by {} {} in {} {}.{}Elapsed Time: {}s".format(extension.getDisplayName().replace(" ", ""), extension.getVersion(), *libreversion, chr(0x00A0)*5, end-start)
	bodynode.append(Elem("p", text=txt))
